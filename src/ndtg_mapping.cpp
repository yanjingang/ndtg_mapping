...
int main(int argc, char **argv)
{
  ...
  std::cout << "tf_x: " << _tf_x << std::endl;
  std::cout << "tf_y: " << _tf_y << std::endl;
  std::cout << "tf_z: " << _tf_z << std::endl;
  std::cout << "tf_yaw: " << _tf_yaw << std::endl;
  std::cout << "tf_pitch: " << _tf_pitch << std::endl;
  std::cout << "tf_roll: " << _tf_roll << std::endl;
  ...
  ndt_map_pub = nh.advertise<sensor_msgs::PointCloud2>(_map_topic, 1000);
  current_pose_pub = nh.advertise<geometry_msgs::PoseStamped>(_pose_topic, 1000);
  gps_path_pub = nh.advertise<nav_msgs::Path>(_gps_path_topic, 10);
  ...
  ros::Subscriber gps_sub = nh.subscribe(_gps_topic, 100000, gps_callback);
